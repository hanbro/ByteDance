...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onStart(){
        super.onStart();
        System.out.println("日志 on start");
    }

    @Override
    protected void onResume(){
        super.onResume();
        System.out.println("日志 on resume");
    }

    @Override
    protected void onPause(){
        super.onPause();
        System.out.println("日志 on pause");
    }

    @Override
    protected void onStop(){
        super.onStop();
        System.out.println("日志 on stop");
    }

    @Override
    protected void onDestroy(){
        super.onDestroy();
        System.out.println("日志 on destory");
    }
}
